...
@register.inclusion_tag("wine/components/evaluations.html")
...
@register.inclusion_tag("wine/components/trending.html")
...
@register.inclusion_tag("wine/components/attribution.html")
