"""
Django settings for vinipedia_backend project.
...
ROOT_URLCONF = 'vinipedia_backend.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'wine.context_processor.search_form',
            ],
        },
    },
]

WSGI_APPLICATION = 'vinipedia_backend.wsgi.application'
